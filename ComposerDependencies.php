 ...
 * `ManufacturerConsolidation` token in the namespace below with your module's name, e.g.
 * for ksf_FA_HRM:
 *
 ...
 *  - Each module that DOES rename ManufacturerConsolidation gets its own class in its own
 ...
 *  - If you FORGET to replace ManufacturerConsolidation, every unrenamed copy collapses onto
 *    the same placeholder namespace `ksfraser\FrontAccounting\ManufacturerConsolidation\Utils`;
...
namespace ksfraser\FrontAccounting\ManufacturerConsolidation\Utils;
